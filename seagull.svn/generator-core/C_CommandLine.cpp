...
#endif
  iostream_error << " This is customized version of Seagull tool to support MD5 Hash calculation for Diameter Protocol(Digest-HA1 AVP)" << iostream_endl ;
  iostream_error << " Usage: param=\"lib=lib_crypto.so;function=crypto_method_diameter\"" << iostream_endl ;
  iostream_error << " Parameters: username, realm, password" << iostream_endl ;
  iostream_error << " Author: Agnivesh Kumpati" << iostream_endl ;
  iostream_error << iostream_endl ;
