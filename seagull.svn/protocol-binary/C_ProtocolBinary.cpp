...
int C_ProtocolBinary::find_header_body_id (char *P_name) {
  ...
  GEN_DEBUG(1, "C_ProtocolBinary::find_header_body_id() start");
  L_it = m_header_body_id_map 
    -> find (T_IdMap::key_type(P_name)) ;
  ...
  GEN_DEBUG(1, "C_ProtocolBinary::find_header_body_id() end");
...
int C_ProtocolBinary::find_body_value_id (char *P_name) {
  ...
  GEN_DEBUG(1, "C_ProtocolBinary::find_body_value_id() start");
  ...
  GEN_DEBUG(1, "C_ProtocolBinary::find_body_value_id() end");
