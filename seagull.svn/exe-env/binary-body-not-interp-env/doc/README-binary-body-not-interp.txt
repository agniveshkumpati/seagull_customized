...
0. Protocol package content
   ...
   the Seagull directory contains an binary-body-not-interp directory:
     /usr/local/share/seagull/binary-body-not-interp         
...
3. Configuration
   ...
   (cf. /usr/local/share/seagull/binary-body-not-interp/config/conf.client.xml 
    and /usr/local/share/seagull/binary-body-not-interp/config/conf.server.xml) 
...
(cf. /usr/local/share/seagull/binary-body-not-interp/scenario/client_<1/2>.xml 
 and /usr/local/share/seagull/binary-body-not-interp/scenario/server_<1/2>.xml) 
